...
from backend.client import AgentClient, AgentClientError
from backend.schema import ChatHistory, ChatMessage
from backend.schema.task_data import TaskData, TaskDataStatus
    ...
    while msg := await anext(messages_agen, None):
        ...
        match msg.type:
            ...
            case "custom":
                ...
                # See:
                # - backend/agents/utils.py CustomData
                # - backend/agents/bg_task_agent/task.py
                try:
